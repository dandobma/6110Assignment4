...
This study performed a comprehensive scRNA-seq analysis of the murine nasal mucosa during influenza A virus infection, characterizing cell type composition, differential gene expression, pathway enrichment, and myeloid differentiation trajectories. Thirty-six transcriptionally distinct cell populations were identified across three tissue compartments and five timepoints, spanning immune, neuronal, epithelial, and stromal lineages (Figure 1). The annotated UMAP reveals the cellular complexity of the nasal mucosa and provides a foundation for understanding tissue-specific responses to infection. The diversity of identified cell types, including rare populations such as tuft cells, vomeronasal sensory neurons, and osteoblasts, is consistent with published transcriptomic atlases of the mouse nasal cavity (Ruiz Tejada Segura et al., 2022) and reflects the broad anatomical scope of the three tissues sampled.

The differential expression analysis of macrophages in the RM tissue comparing Naive to D05 identified widespread downregulation of ribosomal protein genes and immediate early response genes (Figure 3). The downregulation of ribosomal genes such as *Rps21*, *Rps27*, and multiple *Rpl* family members is consistent with a transition from a homeostatic, translationally active state in naive tissue-resident macrophages to a metabolically reprogrammed inflammatory state during infection. The downregulation of ribosomal machinery genes in inflammatory macrophages has been reported previously and may reflect a transition in translational priorities during immune activation (Jia et al., 2024). The downregulation of immediate early genes including *Fos*, *Ier2*, and *Egr1* in D05 macrophages relative to Naive is somewhat counterintuitive, as these genes are typically associated with activation and stress responses. However, these genes are highly expressed in tissue-resident macrophages under homeostatic conditions, and their downregulation during active infection may reflect displacement of naive tissue-resident macrophages by infiltrating monocyte-derived cells that do not share this baseline expression pattern (Guilliams et al., 2013). Among upregulated genes, *Ly6c2* is a canonical marker of classical inflammatory monocytes and monocyte-derived macrophages, and its strong upregulation at D05 supports the hypothesis that the macrophage cluster at this timepoint is increasingly composed of recently recruited monocyte-derived cells rather than tissue-resident macrophages (Misharin et al., 2017). *Isg15*, an interferon-stimulated gene induced by type I interferon signaling, was also significantly upregulated at D05, consistent with an active antiviral transcriptional response (Perng & Bhatt, 2019).

GSEA revealed that all significantly enriched pathways at D05 versus Naive were in the suppressed direction and were exclusively related to translational and ribosomal biology (Figures 4 and 5). The complete absence of enriched upregulated pathways at the GO:BP level warrants interpretation. It is possible that upregulated biological processes, such as cytokine signaling, innate immune activation, or phagocytosis, are represented by gene sets too small or too heterogeneous to achieve statistical enrichment thresholds in GSEA. The dominance of ribosomal suppression as the leading transcriptional signature of D05 macrophages is consistent with the concept of translational reprogramming during macrophage activation, in which global protein synthesis is repressed while selective translation of inflammatory mediators is maintained (Piccirillo et al., 2014). The uniformly suppressed running enrichment score for cytoplasmic translation (Figure 5) confirms that this signal is strong and consistent across the ranked gene list.

Cell composition analysis revealed that the RM tissue undergoes substantial immune cell infiltration during IAV infection, with monocytes and NK cells peaking at D08 before declining toward D14 (Figure 7). Macrophages showed an inverse pattern, declining from their naive abundance through D05–D08 and partially recovering by D14 (Figure 8). This pattern is consistent with the established model of IAV-induced macrophage depletion and subsequent monocyte-driven replenishment, as has been documented in the lung (Hashimoto et al., 2013; Guilliams et al., 2013). The failure of the linear model to detect a statistically significant change in macrophage proportions over time (p = 0.945) is attributable to the non-linearity of the response and the limited sample size of three replicates per timepoint, rather than the absence of a biological effect. Compositional analysis tools designed specifically for scRNA-seq data, such as scCODA (Büttner et al., 2021) or Milo (Dann et al., 2022), which account for the compositional nature of cell type proportions, would provide more statistically rigorous inference in future analyses.

The trajectory analysis provides evidence for a monocyte-to-macrophage differentiation continuum in the RM tissue during IAV infection (Figures 9 and 10). Slingshot inferred three myeloid lineages, all originating from monocytes and passing through a dendritic cell intermediate before terminating in macrophages, neutrophils, or immature neutrophils. The continuous pseudotime gradient across the monocyte-macrophage boundary (Figure 9), combined with the enrichment of monocyte-derived cell markers such as *Ly6c2* in D05 macrophages, supports the interpretation that blood-derived monocytes infiltrating the RM during infection progressively acquire a macrophage-like transcriptional identity. This trajectory is consistent with published reports of monocyte-to-macrophage differentiation during pulmonary IAV infection (Misharin et al., 2017) and extends the characterization of this process to the nasal mucosa. The identification of dendritic cells as a transcriptional intermediate across all three lineages may reflect the shared myeloid progenitor biology of macrophages, dendritic cells, and granulocytes, rather than a true dendritic cell differentiation intermediate in vivo (Guilliams et al., 2014). The trajectory should therefore be interpreted as a transcriptional continuum rather than a strict developmental sequence.

Several limitations of this study should be acknowledged. First, the use of log-normalization rather than SCTransform for data normalization represents a suboptimal approach relative to current best practices, and may have reduced the sensitivity of variable feature selection and clustering. SCTransform was not feasible due to memory constraints, and future analyses on high-memory systems should rerun the pipeline with SCTransform (Hafemeister & Satija, 2019). Second, 56,050 cells (approximately 36% of the filtered dataset) lacked an assigned mouse_id and were therefore excluded from pseudobulk differential expression analysis, which requires replicate-level aggregation. The origin and representativeness of these unassigned cells remains unclear and constitutes a potential source of bias. Third, with only three biological replicates per condition, the statistical power of pseudobulk differential expression analysis is limited, and findings should be interpreted with appropriate caution. Fourth, trajectory analysis does not establish causal differentiation relationships; the inferred monocyte-to-macrophage trajectory reflects transcriptional similarity rather than confirmed developmental lineage, and validation with lineage-tracing experiments would be required to confirm this interpretation (Guilliams et al., 2013). Nonetheless, the convergence of evidence from differential expression, cell composition analysis, and trajectory inference provides a consistent and biologically coherent picture of myeloid dynamics during IAV infection of the nasal mucosa.
